...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
            ...
            <li class="message-item">
              <a href="#">
                <img src="<?= base_url('assets/img/messages-3.jpg') ?>" class="rounded-circle">
                <div>
                  <h4>David Muldon</h4>
                  <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                  <p>8 hrs. ago</p>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link grid" href="<?= base_url('profile'); ?>">
          <i class="bi bi-person"></i>
          <span>Profile</span>
        </a>
      </li><!-- End Profile Page Nav -->
            ...
            <div class="tab-pane fade show active" id="profile-overview" style="background-color: #f8f9fa; border-radius: 8px; padding: 20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
              <?php if (isset($professeur) && !empty($professeur)): ?>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-lg-9 col-md-8" style="color: #333; background-color: #fff; padding: 8px; border-radius: 4px;">
                    <?= esc($professeur['prenom']); ?>
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-lg-3 col-md-4 label" style="font-weight: bold; color: #555;">Department</div>
                  <div class="col-lg-9 col-md-8" style="color: #333; background-color: #fff; padding: 8px; border-radius: 4px;">
                    <?= esc($professeur['departement']); ?>
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-lg-3 col-md-4 label" style="font-weight: bold; color: #555;">Modules</div>
                  <div class="col-lg-9 col-md-8" style="color: #333; background-color: #fff; padding: 8px; border-radius: 4px;">
                    <?= !empty($modules) ? implode(', ', $modules) : 'No modules assigned'; ?>
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-lg-3 col-md-4 label" style="font-weight: bold; color: #555;">Email</div>
                  <div class="col-lg-9 col-md-8" style="color: #333; background-color: #fff; padding: 8px; border-radius: 4px;">
                    <?= esc($professeur['email']); ?>
        ...
        <div class="col-xl-8">
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <p><strong>Nom :</strong> <?= esc($professeur->nom); ?></p>

              <div class="col-lg-9 col-md-8">dounia</div>
              </div>
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Modules</div>
