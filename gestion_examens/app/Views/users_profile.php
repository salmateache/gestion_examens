            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-pane fade show active profile-overview" id="profile-overview">
                      ...
                      <div class="row">
                          ...
                          <div class="col-lg-9 col-md-8"><?= esc($professeur['nom']); ?></div>
                      </div>

                      <div class="row">
                          <div class="col-lg-3 col-md-4 label">First Name</div>
                          <div class="col-lg-9 col-md-8"><?= esc($professeur['prenom']); ?></div>
                      </div>

                      <div class="row">
                          <div class="col-lg-3 col-md-4 label">Department</div>
                          <div class="col-lg-9 col-md-8"><?= esc($professeur['departement']); ?></div>
                      </div>
                      ...
                      <div class="row">
                          ...
                          <div class="col-lg-9 col-md-8"><?= esc($professeur['email']); ?></div>
                      </div>
